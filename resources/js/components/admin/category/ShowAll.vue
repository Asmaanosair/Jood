        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">الاقسام الرئسية </h4>
                    <h6 class="card-subtitle">رؤية جميع الاقسام</h6>
                    <table class="table table-striped table-bordered" id="zero_config">
                        ...
                        <tr v-for="category in categories">
                            ...
                            <td class="center"> <button type="button" class="btn btn-danger  m-t-10 mb-2 float-right" @click="DeleteCategory(category.id)"> <i class="fa fa-trash"></i>  </button></td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            EditCategory($id){
                this.allErrors=[];
                axios.get('/admin/category/'+$id+'/edit').then(res => {
            ...
            AddCategory() {
                ...
                axios.post('/admin/category', formData, {headers:{'Content-Type': 'multipart/form-data'}})
                    .then(function(){
                        self.allErrors=[]
                        self.GetCategories();
                        self.$swal({
            ...
            UpdateCategory($id) {
                ...
                axios.post('/admin/category/'+$id, formData, {headers:{'Content-Type': 'multipart/form-data'}})
                    .then(function(res){
                      self.GetCategories();
                        self.$swal({
