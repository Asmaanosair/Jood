...
<script>
    export default {
        ...
        methods: {
            GetCities(){
                axios.get('/admin/city').then(res => {
                   this.cities=res.data.cities
                   this.regions=res.data.regions
                })
            },
            EditCity($id){
                axios.get('/admin/city/'+$id+'/edit').then(res => {
            ...
            AddCities() {
                ...
                axios.post('/admin/city', formData)
                    .then(function(){
                        self.GetCities();
                        self.allErrors=[]
                        self.$swal({
            ...
            DeleteCity($id){
                this.$swal({
                    ...
                    if (result.value) {
                        axios.delete('/admin/city/'+$id).then(res => {
                            this.GetCities()
                        })
                        this.$swal(
                            'تم الحذف بنجاح ',
            ...
            UpdateCity($id) {
                ...
                axios.post('/admin/city/'+$id, formData)
                    .then(function(res){
                        self.GetCities();
                        self.$swal({
